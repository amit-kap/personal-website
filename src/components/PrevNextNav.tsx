      ...
      <div className="flex-1 min-w-0">
        {prev && (
          <Link to={prev.to} className="group inline-flex flex-col items-start gap-1.5">
            <span className="text-caption font-mono uppercase tracking-[0.2em] text-black/35">← Previous</span>
      ...
      <div className="flex-1 min-w-0 flex justify-end">
        {next && (
          <Link to={next.to} className="group inline-flex flex-col items-end gap-1.5 text-right">
            <span className="text-caption font-mono uppercase tracking-[0.2em] text-black/35">Next →</span>
            <span className="text-meta font-medium text-black/70 group-hover:text-black transition-colors leading-snug">
              {next.label}
            </span>
          </Link>
