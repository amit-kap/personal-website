...
const stories: Record<string, CompactStory> = {
  'onyxia-cyber': {
    ...
    heroPlate: 'var(--surface-muted)',
    problemBg: 'var(--foreground)',
    problemAccent: '#ffffff',
    proofPlate: 'var(--surface-muted)',
  },
  veriti: {
    ...
    response: 'Veriti connected a threat to the configuration gap, affected products, and expected effect. One finding became a controlled change, not another dashboard.',
  ...
  semperis: {
    ...
    response: 'The design work defined how alerts, insights, and notifications differ. It also clarified how teams move from a detected weakness to the decision that needs attention.',
  ...
  checkpoint: {
    ...
    response: 'The redesign rethought the relationship between products, objects, policies, alerts, and daily tasks. It gave that structure a modern, coherent interface.',
