...
export default function SkeletonImage({
  ...
  return (
    <div className={`relative overflow-hidden ${wrapperClassName}`}>
      ...
      />
      {currentState === 'error' && (
        <div className="absolute inset-0 flex items-center justify-center bg-neutral-100 px-4 text-center text-caption font-mono uppercase tracking-[0.18em] text-black/30">
          Image unavailable
        </div>
      )}
    </div>
